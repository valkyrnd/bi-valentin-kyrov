...
FROM            dim.SKU AS s 
		LEFT OUTER JOIN dim.Brand AS b ON b.ID = s.ID_Brand 
		LEFT OUTER JOIN md_bi.SKUAdditionalInfo AS si ON si.ID = s.ID_mapping_MDT 
		LEFT OUTER JOIN bi.BusinessUnit AS u ON u.ID = si.ID_bi_BusinessUnit
